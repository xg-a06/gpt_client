...
const List = () => (
  <div className={style['list-container']}>
    <div className="select-tips">Model: GPT-4</div>
    <div className="list-item list-item-user">
      <div className="list-item-avatar">
        <UserOutlined />
      </div>
      <div className="list-item-content">你好</div>
    </div>
    <div className="list-item list-item-assistant">
      <div className="list-item-avatar">
        <RobotOutlined />
      </div>
